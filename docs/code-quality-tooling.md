...
on this tree, and the numbers say why. 445 definitions qualify, and nearly all are
...
under "Known limits" — and it reports **100** rows today where the reachability
