...
# THE DECIDING CASE, measured 2026-09-11 with the real toolchain in
# ghcr.io/kataglyphis/kataglyphis_beschleuniger:winamd64 over a copy of
...
tree_scope_note() {
  ...
  note "~/.npm, \$HOME, a sibling checkout -- and this run neither watched those nor"
